        ...
        try {
            ...
            try {
                ...
                if (modifyButtons.length === 0) {
                    ...
                    console.log(`총 ${modifyButtons.length}개의 '주문수정' 버튼을 순차적으로 처리합니다.`);
                }

                for (let modifyIndex = 0; modifyIndex < modifyButtons.length; modifyIndex++) {
                    const modifyButton = modifyButtons[modifyIndex];
                        ...
                        if (optionDropdown) {
                            ...
                            try {
                                ...
                                if (optionButtons.length > 0) {
                                    ...
                                    const maxIterations = Math.min(3, optionButtons.length - 1);
